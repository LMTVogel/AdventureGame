...
function startscreen() {
	...
	gameContainer.insertBefore(gameImage, gameContainer.childNodes[2]);
	gameImage.src="images/goeie.png";
...
function winNoDiamants() {
	...
	gameImage.src="images/win.png";
	title.innerHTML="YOU WIN! But you're poor because you didn't took the diamants."
...
function winDiamants() {
	...
	gameImage.src="images/win.png";
	title.innerHTML="YOU WIN! And you have a lot of money.";
	description.innerHTML="Well done.";
	button2.style.display="none";
	button3.style.display="none";
	startMusic.pause();
...
function level3() {
	console.log("Level 3");
	gameImage.src="images/cave.jpeg"
...
function level4() {
	console.log("Level 4");
	gameImage.src="images/cavehouse.jpg"
...
function level5() {
	console.log("Level 5");
	gameImage.src="images/bottle.jpg"
...
function level6() {
	console.log("Level 6");
	gameImage.src="images/skelet.png"
...
function level7() {
	console.log("Level 7");
	gameImage.src="images/mijn.jpeg"
...
function level8() {
	console.log("Level 8");
	gameImage.src="images/boom.jpeg"
...
function level9() {
	console.log("Level 9");
	gameImage.src="images/pickaxe.png"
...
function level10() {
	...
	gameImage.src="images/iron.jpeg"
...
function level12() {
	...
	gameImage.src="images/diamant.png"
